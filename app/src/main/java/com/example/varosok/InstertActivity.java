            ...
            public void onClick(View view) {
                ...
                if (varos.isEmpty()) {
                    Toast.makeText(InsertActivity.this,
                            "A Város nem lehet üres", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (orszag.isEmpty()) {
                    Toast.makeText(InsertActivity.this,
                            "Ország nem lehet üres", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (lak.isEmpty()) {
                    Toast.makeText(InsertActivity.this,
                            "Lakosság nem lehet üres", Toast.LENGTH_SHORT).show();
                    return;
                }
                Gson conv = new Gson();
